...
$TextBox.text = "Le bouton 'Sauvegarde', sauvegardera votre profil utilisateur à l'endroit que vous sélectionnerez`r`nkjnkjnjjjjjjjjjjjjjj"
$TextBox.width                      = 343
$TextBox.height                     = 145
...
# Création de la fonction "Mot" (volée sur le web xD) pour la copie d'un dossier en ne récupérant QUE son nom
Function Mot {
    Param(
...
if ($Sauvegarde.Checked) {
    ...
    $DestinationPath.Description         = " /!\ Choisir un dossier /!\ "
    ...
    $Name                                = Mot -string $SourcePath -character "\" -range Right
