...
# Option "user backup" sélectionnée
    ...
    # Fin
        ...
        # Définition des options RoboCopy
            $Options = "*.* /s /z /zb /tee /Eta /copyall /secfix /timfix $MT $XF /MIR /J /r:5 /w:2 /Xo /log+:$env:USERPROFILE\$log"
        # Fin
...
# Option de 'user restore' sélectionnée
    ...
    # Définition de la Source, de la Destination ainsi que de leur validité
        ...
        # Fin
    # Définition des options RoboCopy
        $Options = "*.* /s /z /zb /tee /Eta /copyall /secfix /timfix /MT:8 /MIR /J /r:5 /w:2 /Xo /log+:$env:USERPROFILE\$log"
    # Fin
    # Fin
